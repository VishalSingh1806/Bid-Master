...
namespace project.Admin
{
    public partial class active : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            con.Open();
            string matchQry = "select id from [admin] where email='" + email + "' and activation_code='" + activation_code + "' and is_active=0";
            ...
            if (matchReader.HasRows)
            {
                ...
                con.Open();
                string updateQry = "update [admin] set activation_code='0', is_active=1 where email='" + email + "'";
