    ...
    public partial class signup : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                con.Open();
                String insertQry = "insert into [users] (name,  email,number, password, activation_code, is_active ) values (@name,@email,@number, @password, @activation_code, @is_active)";
                ...
                emailBody += "<p style='text-align: center; margin: 24px 0;'><a href='http://localhost:52301/Activate.aspx?activation_code=" + activation_code + "&email=" + Base64Encode(email.Text.Trim()) + "' style='border: 2px solid #A05eff; color: #fff; background-color: #A02eff; text-decoration: none; padding: 12px 20px;'> ACTIVATE ACCOUNT </a></p>";
                ...
                smtp.Send(mail);
                string script = "alert('An Email has been sent to you registerd Mail id! Kindly activate your account from there.'); window.location.href = 'login.aspx';";
